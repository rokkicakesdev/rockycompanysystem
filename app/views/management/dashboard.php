  ...
  <div class="content p-4">
    ...
    <div class="row mb-4">
      <div class="col-xl-3 col-md-6 mb-3">
        <div class="stat-card">
          ...
          <div><div class="stat-value"><?= $stats['total_employees'] ?></div><div class="stat-label">Active Employees</div></div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6 mb-3">
        <div class="stat-card">
          <div class="icon-box" style="background:#fef3c7;color:#d97706;"><i class="fas fa-calendar-minus"></i></div>
          <div><div class="stat-value"><?= $stats['pending_leaves'] ?></div><div class="stat-label">Pending Leaves</div></div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6 mb-3">
        <div class="stat-card">
          <div class="icon-box" style="background:#dcfce7;color:#16a34a;"><i class="fas fa-peso-sign"></i></div>
          <div><div class="stat-value">₱<?= number_format($stats['last_month_payroll']/1000, 1) ?>k</div><div class="stat-label">Last Month Payroll</div></div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6 mb-3">
        <div class="stat-card">
          <div class="icon-box" style="background:#f3e8ff;color:#7c3aed;"><i class="fas fa-briefcase"></i></div>
          <div><div class="stat-value"><?= $stats['open_jobs'] ?></div><div class="stat-label">Open Job Postings</div></div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-5 mb-4">
        <div class="card">
          <div class="card-header"><i class="fas fa-sitemap mr-2"></i>Headcount by Department</div>
          <div class="card-body p-0">
            <table class="table table-hover mb-0">
              <thead><tr><th>Department</th><th class="text-center">Count</th></tr></thead>
              <tbody>
      ...
      <div class="col-md-7 mb-4">
        <div class="card">
          <div class="card-header d-flex justify-content-between">
            <span><i class="fas fa-money-check-alt mr-2"></i>Latest Payroll — <?= $latestPeriod ?></span>
            <a href="payroll.php" class="btn btn-xs btn-outline-primary">Full Report</a>
          </div>
          <div class="card-body p-0">
            <div class="table-responsive" style="max-height:300px;overflow-y:auto;">
              <table class="table table-sm table-hover mb-0">
                <thead><tr><th>Employee</th><th>Gross</th><th>Net Pay</th><th>Status</th></tr></thead>
                <tbody>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php if (empty($announcements)): ?>
              <p class="text-muted text-center py-2">No active announcements.</p>
            <?php else: ?>
              <div class="row">
                <?php
                ...
                <div class="col-md-4 mb-3">
                  <div style="border-left:4px solid <?= $color ?>;padding:12px;background:#f8fafc;border-radius:0 8px 8px 0;">
                    ...
                    <p style="font-size:.78rem;color:#64748b;margin:6px 0 0;"><?= nl2br(htmlspecialchars(substr($ann['content'], 0, 100))) ?>...</p>
