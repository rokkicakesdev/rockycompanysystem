<?php
// app/views/admin/bir_2316_export.php
// Generates a Dompdf PDF of BIR Form 2316 (Sep 2021 ENCS) with all employee data populated.
// Usage: bir_2316_export.php?year=2026&emp_id=1
...
// ── Computed figures (same as bir_2316.php) ───────────────────────
...
$empTin     = htmlspecialchars($employee['tin_no']    ?? '');
...
// ── HTML ──────────────────────────────────────────────────────────
$html = "<!DOCTYPE html><html><head><meta charset='UTF-8'><style>{$css}</style></head><body><div class='page'><div class='bir-form'>";

// Top bar
$html .= "
<div class='top-bar'>
  <div class='top-left'>For BIR<br>Use Only<br>BCS/<br>Item:<br><strong style='font-size:10pt;'>2316</strong></div>
  <div class='top-center'>
    ...
    <div style='font-size:5.5pt;'>BIR Form No.</div>
  ...
  <div class='top-right'>
    ...
    <div style='font-size:7pt;font-weight:700;'>2316 9/21ENCS</div>
  </div>
</div>
...
// Two-column body
$html .= "<div class='body-wrap'><div class='col-left'>";

// Part I
$html .= "<div class='sec-hdr'>Part I - Employee Information</div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>3</span> TIN</div><div class='fval'>{$empTin}</div></div>";
$html .= "<div class='drow'><div class='dcell' style='width:65%'><span class='fnum'>4</span> Employee's Name <em>(Last Name, First Name, Middle Name)</em><br><strong style='font-size:7pt;'>{$empName}</strong></div><div class='dcell dcell-r'><span class='fnum'>5</span> RDO Code<br><span>—</span></div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>6</span> Registered Address</div><div class='fval' style='font-size:6pt;'>{$empAddress}</div></div>";
$html .= "<div class='drow'><div class='dcell' style='width:65%;'><span class='fnum'>6B</span> Local Home Address</div><div class='dcell dcell-r'><span class='fnum'>6C</span> ZIP Code</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>6D</span> Foreign Address</div><div class='fval'></div></div>";
$html .= "<div class='drow'><div class='dcell' style='width:50%;'><span class='fnum'>7</span> Date of Birth <em>(MM/DD/YYYY)</em><br><strong>{$empBirth}</strong></div><div class='dcell dcell-r'><span class='fnum'>8</span> Contact Number<br><strong>{$empPhone}</strong></div></div>";
$html .= "<div class='drow'><div class='dcell' style='width:50%;'><span class='fnum'>9</span> Statutory Min. Wage/day</div><div class='dcell dcell-r'><span class='fnum'>10</span> Statutory Min. Wage/month</div></div>";
$html .= "<div class='frow frow-nb'><div class='flabel' style='width:100%;padding:2px 3px;'><span class='fnum'>11</span> <span class='chk'>&nbsp;</span> Minimum Wage Earner (MWE) exempt from withholding tax</div></div>";

// Part II
$html .= "<div class='sec-hdr'>Part II - Employer Information (Present)</div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>12</span> TIN</div><div class='fval'>—</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>13</span> Employer's Name</div><div class='fval'>" . htmlspecialchars($companyName) . "</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>14</span> Registered Address</div><div class='fval' style='font-size:6pt;'>" . htmlspecialchars($companyAddress) . "</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>14A</span> ZIP Code</div><div class='fval'>—</div></div>";
$html .= "<div class='frow frow-nb' style='padding:2px 4px;font-size:6pt;'><span class='fnum'>15</span> Type of Employer &nbsp;<span class='chk'>&#10003;</span> Main Employer &nbsp;<span class='chk'>&nbsp;</span> Secondary Employer</div>";

// Part III
$html .= "<div class='sec-hdr'>Part III - Employer Information (Previous)</div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>16</span> TIN</div><div class='fval'>&nbsp;</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>17</span> Employer's Name</div><div class='fval'>&nbsp;</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>18</span> Registered Address</div><div class='fval'>&nbsp;</div></div>";
$html .= "<div class='frow'><div class='flabel'><span class='fnum'>18A</span> ZIP Code</div><div class='fval'>&nbsp;</div></div>";

// Part IVA Summary
$html .= "<div class='sec-hdr'>Part IVA - Summary</div>";
$sumRows = [
...
$html .= "<div style='padding:1px 4px;font-size:5.5pt;font-weight:700;border-bottom:1px solid #eee;'><span class='fnum'>25</span> Amount of Taxes Withheld</div>";
$html .= "<div class='srow'><div class='slabel'>&nbsp;&nbsp;<span class='fnum'>25A</span> Present Employer</div><div class='sbox'>{$f($totalTax)}</div></div>";
$html .= "<div class='srow'><div class='slabel'>&nbsp;&nbsp;<span class='fnum'>25B</span> Previous Employer, if applicable</div><div class='sbox'></div></div>";
$html .= "<div class='srow'><div class='slabel'><span class='fnum'>26</span> Total Taxes Withheld as adjusted (Sum of 25A and 25B)</div><div class='sbox'>{$f($totalTax)}</div></div>";
$html .= "<div class='srow'><div class='slabel'><span class='fnum'>27</span> 5% Tax Credit (PERA Act of 2008)</div><div class='sbox'></div></div>";
$html .= "<div class='srow'><div class='slabel'><span class='fnum'>28</span> Total Taxes Withheld (Sum of Items 26 and 27)</div><div class='sbox'>{$f($totalTax)}</div></div>";

$html .= "</div>"; // end col-left

// RIGHT COLUMN — Part IV-B
$html .= "<div class='col-right'>";
$html .= "<div class='sec-hdr'>Part IV-B Details of Compensation Income &amp; Tax Withheld from Present Employer</div>";
$html .= "<div class='sec-hdr-gray'>A. NON-TAXABLE/EXEMPT COMPENSATION INCOME &nbsp;&nbsp;<span style='float:right;'>Amount</span></div>";

$nonTaxRows = [
    ['29', 'Basic Salary (incl. exempt &#8369;250,000 &amp; below) or SMW of MWE', ''],
    ['30', 'Holiday Pay (MWE)', ''],
    ['31', 'Overtime Pay (MWE)', ''],
...
foreach ($nonTaxRows as [$n,$l,$v]) {
    $bold = ($n === '38') ? "style='font-weight:700;border-top:1.5px solid #000;'" : '';
    $html .= "<div class='arow {$bold}'><div class='alabel'><span class='fnum'>{$n}</span> {$l}</div><div class='abox'>{$v}</div></div>";
}

$html .= "<div class='sec-hdr-gray' style='margin-top:2px;'>B. TAXABLE COMPENSATION INCOME &nbsp;&nbsp;<span style='float:right;'>REGULAR</span></div>";

$taxableRows = [
    ['39', 'Basic Salary', $f(max(0, $totalBasic - $govDeds))],
    ['40', 'Representation', ''],
    ['41', 'Transportation', ''],
    ...
    ['48', 'Taxable 13th Month Benefits', $f($taxableThirteenth)],
    ['49', 'Hazard Pay', ''],
    ['50', 'Overtime Pay', ''],
    ['51', 'Others (specify)', ''],
    ['51A', '', ''],
...
$html .= "<div class='arow arow-bold'><div class='alabel'><span class='fnum'>52</span> Total Taxable Compensation Income (Sum of Items 39 to 51B)</div><div class='abox'>{$f($item52)}</div></div>";
$html .= "<div class='arow' style='background:#fffde7;border-top:1px solid #000;'><div class='alabel'><span class='fnum'>53</span> <strong>Total Amount of Taxes Withheld as adjusted</strong></div><div class='abox' style='font-weight:900;'>{$f($totalTax)}</div></div>";

$html .= "</div></div>"; // end col-right, body-wrap

// Certification
$html .= "
<div class='cert'>
  <div style='font-size:5.5pt;'>I/We declare, under the penalties of perjury that this certificate has been made in good faith, verified by me/us, and to the best of my/our knowledge and belief, is true and correct, pursuant to the provisions of the National Internal Revenue Code, as amended, and the regulations issued under authority thereof. Further, I/we give my/our consent to the processing of my/our information as contemplated under the *Data Privacy Act of 2012 (R.A. No. 10173) for legitimate and lawful purposes.</div>
  <div class='sig-grid'>
    <div class='sig-cell'>
      <div class='sig-line'>" . htmlspecialchars($companyName) . "<br><span style='font-size:5pt;'>Present Employer/Authorized Agent Signature over Printed Name</span></div>
    ...
    <div class='sig-cell'>
      ...
      <div class='sig-line'>{$empName}<br><span style='font-size:5pt;'>Employee Signature over Printed Name</span></div>
      <div style='text-align:right;font-size:5.5pt;margin-top:3px;'>Date Signed: <span style='border-bottom:1px solid #000;padding:0 18px;'></span></div>
    </div>
  </div>
  <div style='display:table;width:100%;margin-top:5px;'>
    <div style='display:table-cell;width:50%;border:1px solid #000;padding:3px;font-size:5.5pt;vertical-align:top;'>
    ...
    <div style='display:table-cell;width:50%;border:1px solid #000;padding:3px;font-size:5.5pt;background:#fffde7;vertical-align:top;'>
...
<div class='sub-grid'>
  <div class='sub-cell'>
    <div style='font-size:5.5pt;'>I declare, under the penalties of perjury that the information herein stated are reported under BIR Form No. 1604-C which has been filed with the Bureau of Internal Revenue.</div>
...
$html .= "</div></div></body></html>"; // end bir-form, page
...
$dompdf->setPaper('Legal', 'portrait');  // BIR 2316 is typically printed on legal/long bond
$dompdf->render();
